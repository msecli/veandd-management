...
public class DialogRilevazionePresenze extends Dialog {
	...
	public DialogRilevazionePresenze(Date data, String username) {			
		user=username;
		day=data;
		...
		//layoutContainer.add(txtfldUsername);
		layoutContainer.add(new CreateFormIntervalliOre());
		add(layoutContainer);			
	}
		...
		CreateFormIntervalliOre() {
			...
			/*
		      ...
		      */ 
				...
				dtfldGiorno.setValue(day); 
				dtfldGiorno.setId("data");
			...
			*/
			...
			dtfldGiorno.getDatePicker().addListener(Events.Select, new Listener<DatePickerEvent>() {
				@Override
