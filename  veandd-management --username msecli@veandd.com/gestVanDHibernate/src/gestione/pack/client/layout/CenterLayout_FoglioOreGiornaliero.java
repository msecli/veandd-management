...
public class CenterLayout_FoglioOreGiornaliero extends LayoutContainer {
	public CenterLayout_FoglioOreGiornaliero() {
	...
	public class CreateFormIntervalliOre extends FormPanel {
		...
		CreateFormIntervalliOre() {
			...
			setBorders(false);
			 ...
			 Date retVal = null;
		        try
		        {
		            retVal = DateTimeFormat.getFormat( "dd-MM-yyyy" ).parse( 01+"-"+02+"-"+2013 );
		        }
		        catch ( Exception e )
		        {
		            retVal = null;
			...
			ButtonBar buttonBarConf = new ButtonBar();
			buttonBarConf.add(btnConferma);
			buttonBarConf.setAlignment(HorizontalAlignment.CENTER);
			buttonBarConf.setStyleAttribute("padding-top", "10px");
			buttonBarConf.setStyleAttribute("padding-bottom", "5px");
			buttonBarConf.setBorders(false);
			buttonBarConf.setWidth(320);
			...
			btnConferma.setIcon(AbstractImagePrototype.create(MyImages.INSTANCE.save()));
			...
			btnConferma.addSelectionListener(new SelectionListener<ButtonEvent>() {
				...
				if(frm.isValid()){
					...
					//String oreTotali=txtfldOreTotali.getValue().toString();
					...
					if(controlloDati.compareTo("OK")==0){
					 ...
					 AdministrationService.Util.getInstance().insertFoglioOreGiorno(username, giorno, totOreGenerale, delta, oreViaggio, oreAssRecupero, deltaOreViaggio, 
							 giustificativo, oreStraordinario, oreFerie, orePermesso, "0", intervalliIU, intervalliC, oreRecuperoTot, oreRecuperoTot, new AsyncCallback<Boolean>() {
		...
		protected void reloadFoglioOre() {
			...
			buttonBarConf.add(btnConferma);
			buttonBarConf.setAlignment(HorizontalAlignment.CENTER);
			buttonBarConf.setStyleAttribute("padding-top", "7px");
			buttonBarConf.setStyleAttribute("padding-bottom", "5px");
			buttonBarConf.setBorders(false);
			buttonBarConf.setWidth(320);
	...
	public class FldsetIntervalliIU extends FieldSet {
		...
		private void setIntervalli(List<IntervalliIUModel> result) {
			...
			/*if(sorgente.compareTo(result.get(0).getSorgente())==0)txtfld1I.setEnabled(false);
			if(sorgente.compareTo(result.get(1).getSorgente())==0)txtfld1U.setEnabled(false);
			if(sorgente.compareTo(result.get(2).getSorgente())==0)txtfld2I.setEnabled(false);
			if(sorgente.compareTo(result.get(3).getSorgente())==0)txtfld2U.setEnabled(false);
			if(sorgente.compareTo(result.get(4).getSorgente())==0)txtfld3I.setEnabled(false);
			if(sorgente.compareTo(result.get(5).getSorgente())==0)txtfld3U.setEnabled(false);
			if(sorgente.compareTo(result.get(6).getSorgente())==0)txtfld4I.setEnabled(false);
			if(sorgente.compareTo(result.get(7).getSorgente())==0)txtfld4U.setEnabled(false);
			if(sorgente.compareTo(result.get(8).getSorgente())==0)txtfld5I.setEnabled(false);
			if(sorgente.compareTo(result.get(9).getSorgente())==0)txtfld5U.setEnabled(false);*/
			
			/*if(sostituito.compareTo(result.get(0).getSostituito())==0)txtfld1I.setToolTip("Sostituito");
			if(sostituito.compareTo(result.get(1).getSostituito())==0)txtfld1U.setToolTip("Sostituito");
			if(sostituito.compareTo(result.get(2).getSostituito())==0)txtfld2I.setToolTip("Sostituito");
			if(sostituito.compareTo(result.get(3).getSostituito())==0)txtfld2U.setToolTip("Sostituito");
			if(sostituito.compareTo(result.get(4).getSostituito())==0)txtfld3I.setToolTip("Sostituito");
			if(sostituito.compareTo(result.get(5).getSostituito())==0)txtfld3U.setToolTip("Sostituito");
			if(sostituito.compareTo(result.get(6).getSostituito())==0)txtfld4I.setToolTip("Sostituito");
			if(sostituito.compareTo(result.get(7).getSostituito())==0)txtfld4U.setToolTip("Sostituito");
			if(sostituito.compareTo(result.get(8).getSostituito())==0)txtfld5I.setToolTip("Sostituito");
			if(sostituito.compareTo(result.get(9).getSostituito())==0)txtfld5U.setToolTip("Sostituito");*/
