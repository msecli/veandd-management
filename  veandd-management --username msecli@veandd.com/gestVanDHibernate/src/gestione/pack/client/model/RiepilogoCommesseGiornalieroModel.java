...
public class RiepilogoCommesseGiornalieroModel extends BaseModel implements IsSerializable {
	...
	private RiepilogoCommesseGiornalieroModel(){
		
	}
	
	private RiepilogoCommesseGiornalieroModel(String dipendente, String commessa, String attivita, String giorno1, String giorno2, String giorno3,String giorno4,String giorno5,String giorno6,String giorno7,String giorno8,
