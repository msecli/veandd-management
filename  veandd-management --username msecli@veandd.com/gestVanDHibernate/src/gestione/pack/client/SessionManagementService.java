...
public interface SessionManagementService extends RemoteService {
	...
	boolean setDataReportAnnualeInSession(
			List<RiepilogoOreAnnualiDipendente> listaRiep, String report);
	...
	boolean setDataRiepilogoCommesseInSession(String dataR, String usernameR,
			...
			List<RiepilogoMeseGiornalieroModel> models, RiepilogoFoglioOreModel riepOreTot);
